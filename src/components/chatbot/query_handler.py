...
class QueryHandler:
    ...
    def __init__(
            self,
            embedder: Embedder,
            llm_model_name: str # TODO: REMOVE THIS AND USE SETTINGS
    ) -> None:
        """
        ...
        for chunk in retrieved_chunks:
            try:
                ...
                if hasattr(metadata, "source") and metadata.source:
                    ...
                    logger.debug("Extracted the sources from the chunk")
                    # TODO: CONSIDER ADDING ID TO DOCUMENT CHUNKS + AND JUST USING IDS IN GENERAL
...
# TODO: HAVE A SEPARATE CACHE FOR EMBEDDINGS AND QUERIES
